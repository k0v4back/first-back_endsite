          ...
          <section class="content__left col-md-8">
            <div class="block">
              <div class="block__content">
                ...
                <?php 
                $photovideo = mysqli_query($connect, "SELECT * FROM `photovideo`");

                while ( $pv = mysqli_fetch_assoc($photovideo)) {
                  ?>

                  <?php
                    $art = mysqli_fetch_assoc($photovideo);
                    mysqli_query($connect, "UPDATE `photovideo` SET `views` = `views` + 1 WHERE `id` = " . (int) $pv['id']);
                  ?>
                ...
                <div class="row">
                  <section class="content__left col-md-8">
                    <div class="block" id="one_news">
                      ...
                      <div id="zagolovok_article"style="font-size:18px;"><b style="font-size:20px;"><?php echo $pv['title'];?></div></b><div id="one_news_div" style="font-size: 14px;"> <?php echo date('j '.$monthes[(date('n'))].' Y в G:i', strtotime($pv['pubdate']));?><i style="margin-right: 15px;"></i> <i class="fa fa-hourglass-o" aria-hidden="true" id="padding_right" style="margin-right: 3px;"> </i><?php echo $pv['reading']?><i style="margin-right: 15px; "></i><?php echo $pv['views'];?><i class="fa fa-eye" aria-hidden="true" style="margin-left: 3px;"> </i></div>
                        ...
                        <div class="block__content">
                          <div class="articles articles__horizontal">
                            ...
                            $bd_video = mysqli_query($connect, "SELECT * FROM `video`");

                              while($vid = mysqli_fetch_assoc($bd_video)){
                                ?>




                            <iframe class="col-xs-12 col-md-12" style="margin-bottom: 50px; margin-top: 20px;" width="560" height="315" src="<?php echo $vid['video'];?>" frameborder="0" allowfullscreen></iframe>
